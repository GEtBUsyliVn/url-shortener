...
import (
	...
	"github.com/GEtBUsyliVn/url-shortener/cache/pkg/api/grpc/proto"
	"go.uber.org/zap"
...
func (c *Client) getClient() (proto.CacheServiceClient, error) {
	c.m.Lock()
	defer c.m.Unlock()
	...
	c.client = proto.NewCacheServiceClient(conn)
...
func (c *Client) Get(ctx context.Context, code string) (string, error) {
	...
	resp, err := client.Get(ctx, &proto.CacheGetRequest{ShortCode: code})
	if err != nil {
...
func (c *Client) Set(ctx context.Context, code, url string) error {
	...
	_, err = client.Set(ctx, &proto.CacheSetRequest{ShortCode: code, Url: url})
	if err != nil {
...
func (c *Client) Del(ctx context.Context, code string) error {
	...
	_, err = client.Delete(ctx, &proto.CacheDeleteRequest{ShortCode: code})
	if err != nil {
