...
const (
	AnalyticsService_RecordClick_FullMethodName   = "/main.AnalyticsService/RecordClick"
	AnalyticsService_GetStatistics_FullMethodName = "/main.AnalyticsService/GetStatistics"
)
...
func (c *analyticsServiceClient) RecordClick(ctx context.Context, in *ClickEvent, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedAnalyticsServiceServer) RecordClick(context.Context, *ClickEvent) (*emptypb.Empty, error) {
...
var AnalyticsService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/api/grpc/proto/schema/analytics.proto",
}
