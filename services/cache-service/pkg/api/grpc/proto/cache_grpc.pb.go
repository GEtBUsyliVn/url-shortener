...
const (
	CacheService_Get_FullMethodName    = "/main.CacheService/Get"
	CacheService_Set_FullMethodName    = "/main.CacheService/Set"
	CacheService_Delete_FullMethodName = "/main.CacheService/Delete"
)
...
type CacheServiceClient interface {
	...
	Delete(ctx context.Context, in *CacheDeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *cacheServiceClient) Set(ctx context.Context, in *CacheSetRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *cacheServiceClient) Delete(ctx context.Context, in *CacheDeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type CacheServiceServer interface {
	...
	Delete(context.Context, *CacheDeleteRequest) (*emptypb.Empty, error)
...
func (UnimplementedCacheServiceServer) Set(context.Context, *CacheSetRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Set not implemented")
}
func (UnimplementedCacheServiceServer) Delete(context.Context, *CacheDeleteRequest) (*emptypb.Empty, error) {
...
var CacheService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "cache/pkg/api/grpc/proto/schema/cache.proto",
}
